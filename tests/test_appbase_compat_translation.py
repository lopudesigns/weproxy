...
def test_id_translation(eznode_jussi_request_and_dict):
    jussi_request, jsonrpc_request = eznode_jussi_request_and_dict
...
def test_jsonrpc_translation(eznode_jussi_request_and_dict):
    jussi_request, jsonrpc_request = eznode_jussi_request_and_dict
    urn = jussi_request.urn
    translated_request_dict = JSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
...
def test_jrpc_method_translation(eznode_jussi_request_and_dict):
    jussi_request, jsonrpc_request = eznode_jussi_request_and_dict
    urn = jussi_request.urn
    translated_request_dict = JSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
...
def test_params_api_translation(eznode_jussi_request_and_dict):
    jussi_request, jsonrpc_request = eznode_jussi_request_and_dict
    urn = jussi_request.urn
    translated_request_dict = JSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
...
def test_params_method_translation(eznode_jussi_request_and_dict):
    jussi_request, jsonrpc_request = eznode_jussi_request_and_dict
    urn = jussi_request.urn
    translated_request_dict = JSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
...
def test_params_param_translation(eznode_jussi_request_and_dict):
    jussi_request, jsonrpc_request = eznode_jussi_request_and_dict
    urn = jussi_request.urn
    translated_request_dict = JSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
